...
void	hmodel 		(out half3 hdiffuse, out half3 hspecular, half m, half h, half s, half3 point, half3 normal)
{
	...
	// reflection vector
	half3 	v2point	= mul		(m_v2w,normalize(point));
	...
	// 
	hdiffuse	= env_d*light.xyz 	+ 0.01h	;
